  ...
  return (
    ...
    <div className="w-full ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Soni Auto Market */}
        <div className=" shadow-lg  h-[559px]  rounded-sm">
          ...
          <div className=" flex flex-col gap-y-[16px] py-[50px] px-[23px]">
            <div className="flex items-start gap-3">
              ...
              <span className="text-black">Payment can take 20 days</span>
            </div>
            
            <div className="flex items-start gap-3">
              <LuSmilePlus className="w-8 h-8 flex-shrink-0 text-[#0D9E11]" />
              <span className="text-black">Lengthy inspection</span>
            </div>
            <div className="flex items-start gap-3">
              <LuSmilePlus className="w-8 h-8 flex-shrink-0 text-[#0D9E11]" />
              <span className="text-black">Requires vehicle prep</span>
            </div>
            <div className="flex items-start gap-3">
              <LuSmilePlus className="w-8 h-8 flex-shrink-0 text-[#0D9E11]" />
              <span className="text-black">Be ready to wait</span>
            </div>
            <div className="flex items-start gap-3">
              <LuSmilePlus className="w-8 h-8 flex-shrink-0 text-[#0D9E11]" />
              <span className="text-black">Be ready to wait</span>
    ...
    <div className="w-full ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Soni Auto Market */}
        <div className=" shadow-lg  h-[507px]  rounded-sm">
            <div className="py-6  bg-[#F40000] flex justify-center ">
