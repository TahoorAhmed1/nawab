    ...
    <div className="main">
      <div className="aside1">
        <div className="text" style={{ padding: 10 }}>
          ...
          <br />
              <Link to='/Calculate'><button className="calculate-but all-btn">Calculate Now <i className="fa-solid fa-angle-right"></i></button></Link>
        </div>
      </div>
      <div className="aside2">
        <div className="text" style={{ padding: "10px 0px", width: "30rem" }}>
              <Link to='/ApplyForCredit'><button className="applyonline all-btn">Apply online Today</button></Link>
        </div>
      </div>
    </div>
  </section>
