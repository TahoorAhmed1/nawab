...
const Direction = () => {
    return (
      ...
      <div className="flex flex-col lg:flex-row gap-8 p-8  h-auto">
        {/* Map Section */}
        <div className="p-6 shadow-lg rounded-md w-full h-[auto] diret-wala"  style={{backgroundColor:"#F3F3F3"}}>
        ...
        {/* <div className=" p-6 shadow-lg rounded-md w-[35%] h-max  diret-wala " style={{backgroundColor:"#F3F3F3"}}>
